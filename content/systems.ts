...
export const systems: SystemEntry[] = [
  {
    ...
    long: "We build end-to-end pipeline systems that pull from your sources, enrich each record with company and buying-signal data, and surface a ranked feed of fit-scored prospects. Then we draft the first-touch outreach in your voice. The same partner who built your lead engine built your outreach layer. Nothing gets lost between the two.",
    bullets: [
