...
/**
 * Drive-only hero. The door is /brief/. No wizard fields here.
 * Compact so H1 + Get the Brief sit in the first 390×844 fold.
 */
export function Hero() {
  return (
    <section className="relative overflow-hidden bg-forest-floor text-bone">
      ...
      <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6 pt-10 pb-12 md:pt-16 md:pb-20">
        ...
        <p className="font-sans text-[13px] text-linen/55 leading-relaxed mt-5 max-w-[38ch]">
          Buyer Engine at Paradise Capital is live. Paul&apos;s +30% / +$2M are
          projections.
        </p>
      </div>
    </section>
